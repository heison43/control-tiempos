  ...
  setSubmitMessage(
    'Por favor completa los campos obligatorios: Nombre de quien solicita, Actividad solicitada, Lugar y Número de contacto del responsable.'
  );
  return;
}
  ...
  contactPhone: form.contactPhone.trim(),  // NUEVO
