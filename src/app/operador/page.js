...
const toJsDate = (value) => {
  ...
  try {
    ...
    const start =
      toJsDate(assignment.startTime) ||
      toJsDate(assignment.start_time) ||
      toJsDate(assignment.startedAt)
    ...
    console.error('Error finalizando actividad:', err)
...
>
  <div style={styles.formGroup}>
    ...
    <p style={{ fontSize: '0.875rem', color: '#4b5563', marginBottom: '12px' }}>
      Revisa los avisos internos sobre nuevas actividades, cambios de estado y novedades de tu programación.
    </p>
